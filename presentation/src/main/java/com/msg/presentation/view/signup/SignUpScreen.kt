...
import com.msg.presentation.view.util.toGenderText
    ...
    SignUpViewModelProvider(viewModelStoreOwner = viewModelStoreOwner) { signUpViewModel ->
        ...
        Column(
            ...
            DotoriButton(
                ...
                signUpViewModel.memberName.value = nameText
                signUpViewModel.stuNum.value = stuNumberText
                signUpViewModel.gender.value = genderText.toGenderText()
